...
namespace model_simulate_data_gomp_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_simulate_data_gomp");
    reader.add_event(129, 127, "end", "model_simulate_data_gomp");
    return reader;
}
...
compute_deltay(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& x,
    ...
    try {
        ...
        for (int i = 1; i <= I; ++i) {
            ...
            } else if (as_bool(logical_lt(get_base1(x, i, "x", 1), pC))) {
...
class model_simulate_data_gomp
  : public stan::model::model_base_crtp<model_simulate_data_gomp> {
private:
        int I;
        int N;
        int J;
        ...
        double kappa_ub;
public:
    model_simulate_data_gomp(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_simulate_data_gomp_namespace::model_simulate_data_gomp";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_simulate_data_gomp_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_simulate_data_gomp";
    }
...
typedef model_simulate_data_gomp_namespace::model_simulate_data_gomp stan_model;
#ifndef USING_R
