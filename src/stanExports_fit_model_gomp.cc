...
#include "stanExports_fit_model_gomp.h"

RCPP_MODULE(stan_fit4fit_model_gomp_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_fit_model_gomp")
