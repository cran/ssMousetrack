...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_simulate_data");
    reader.add_event(116, 114, "end", "model_simulate_data");
    return reader;
}
...
compute_deltay(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& x,
    ...
    try {
        ...
        for (int i = 1; i <= I; ++i) {
            ...
            if (as_bool(logical_gt(get_base1(x, i, "x", 1), pC))) {
                current_statement_begin__ = 31;
...
class model_simulate_data
  : public stan::model::model_base_crtp<model_simulate_data> {
private:
        int I;
        int N;
        int J;
        ...
        double kappa_ub;
public:
    model_simulate_data(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_simulate_data_namespace::model_simulate_data";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_simulate_data_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_simulate_data_namespace::model_simulate_data stan_model;
#ifndef USING_R
