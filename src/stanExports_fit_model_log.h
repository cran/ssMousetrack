...
namespace model_fit_model_log_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_fit_model_log");
    reader.add_event(144, 142, "end", "model_fit_model_log");
    return reader;
}
...
class model_fit_model_log
  : public stan::model::model_base_crtp<model_fit_model_log> {
private:
        int I;
        int N;
        int J;
...
public:
    model_fit_model_log(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_fit_model_log_namespace::model_fit_model_log";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_fit_model_log_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_fit_model_log_namespace::model_fit_model_log stan_model;
#ifndef USING_R
