...
#include "stanExports_simulate_data_log.h"

RCPP_MODULE(stan_fit4simulate_data_log_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_simulate_data_log")
